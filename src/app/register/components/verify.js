                    ...
                    {!verificationSuccess ? (
                            ...
                            <form
                                ...
                                <div className="flex gap-2 items-center">
                                    ...
                                    </p>
                                    {
                                        timer ?
                                            <div
                                                className={`text-gray-400 pointer-events-none text-center font-[700] text-[14px]  ml-1`}
                                            >
                                                Click to resend
                                            </div> :
                                            <button
                                                // onClick={ResendOtp}
                                                className={`text-blue-400 text-center font-[700] text-[14px]  ml-1`}
                                            >
                                                Click to resend
                                            </button>
                                    }
                        ...
                        <div className="flex flex-col m-auto max-w-[360px] mt-2 items-center">
                            ...
                            <button
                                ...
                                className="mt-4 bg-blue-400 text-white font-[700] text-[16px] w-full rounded-[4px] h-[47px] hover:bg-white hover:text-blue-400 hover:border hover:border-blue-400"
                            >
                                Continue
                            </button>
